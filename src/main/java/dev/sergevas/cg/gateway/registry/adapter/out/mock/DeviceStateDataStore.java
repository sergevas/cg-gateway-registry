...
public class DeviceStateDataStore {
    ...
    void init() {
        ...
        deviceStateStore.put("growlab-BH1750", new DeviceState("growlab-BH1750", StateType.ACTIVE, OffsetDateTime.now(ZoneOffset.UTC).minusHours(2L)));
        deviceStateStore.put("growlab-IR-CUT_Cam", new DeviceState("0003", StateType.STOPPED, OffsetDateTime.now(ZoneOffset.UTC).minusYears(1L)));
        deviceStateStore.put("growlab-BME280", new DeviceState("0004", StateType.SLEEPING, OffsetDateTime.now(ZoneOffset.UTC)));
